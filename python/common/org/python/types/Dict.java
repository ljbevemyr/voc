...
public class Dict extends org.python.types.Object {
    ...
    @org.python.Method(__doc__ = "dict() -> new empty dictionary"
            ...
            if (args[0] instanceof org.python.types.Dict) {
                ...
                try {
                    while (true) {
                        ...
                        if (data.size() != 2) {
                            throw new org.python.exceptions.ValueError("dictionary update sequence element #"
                                    + generated.size() + " has length " + data.size() + "; 2 is required");
                        }
    ...
    // @org.python.Method(
    // __doc__ = "Create and return a new object. See help(type) for accurate
    // signature."
    // )
    // public org.python.Object __new__() {
    // throw new org.python.exceptions.NotImplementedError("dict.__new__() has not
    // been implemented.");
    // }
    ...
    // throw new org.python.exceptions.NotImplementedError("dict.__init__() has not
    // been implemented.");
    // }
    ...
    public org.python.types.Str __repr__() {
        ...
        for (org.python.Object key : this.value.keySet()) {
            ...
            if (val.toJava() instanceof org.python.internals.Scope) {
                buffer.append(String.format("%s: {...}", key.__repr__()));
            } else {
                buffer.append(String.format("%s: %s", key.__repr__(), val.__repr__()));
            }
        }
        buffer.append("}");
    ...
    @org.python.Method(__doc__ = "__dir__() -> list\ndefault dir() implementation")
    ...
    @org.python.Method(__doc__ = "x.__getitem__(y) <==> x[y]", args = { "item" })
    ...
    @org.python.Method(__doc__ = "Set self[key] to value.", args = { "item", "value" })
    ...
    @org.python.Method(__doc__ = "Delete self[key].", args = { "item" })
    ...
    @org.python.Method(__doc__ = "True if D has a key k, else False.", args = { "item" })
    ...
    @org.python.Method(__doc__ = "D.clear() -> None.  Remove all items from D.")
    public org.python.Object clear() {
        this.value.clear();
        return org.python.types.NoneType.NONE;
    }

    @org.python.Method(__doc__ = "D.copy() -> dict -- a shallow copy of D")
    ...
    @org.python.Method(__doc__ = "Returns a new dict with keys from iterable and values equal to value.", args = {
            "iterable" }, default_args = { "value" })
    ...
    @org.python.Method(__doc__ = "D.get(k[,d]) -> D[k] if k in D, else d.  d defaults to None.", default_args = { "k",
            "d" })
    ...
    @org.python.Method(__doc__ = "D.items() -> a set-like object providing a view on D's items")
    public org.python.Object items() {
        return new org.python.types.DictItems(this);
    }

    @org.python.Method(__doc__ = "D.keys() -> a set-like object providing a view on D's keys")
    ...
    @org.python.Method(__doc__ = "D.pop(k[,d]) -> v, remove specified key and return the corresponding value.\nIf key is not found, d is returned if given, otherwise KeyError is raised", args = {
            "k" }, default_args = { "d" })
    ...
    @org.python.Method(__doc__ = "D.popitem() -> (k, v), remove and return some (key, value) pair as a\n2-tuple; but raise KeyError if D is empty.")
    ...
    @org.python.Method(__doc__ = "D.setdefault(k[,d]) -> D.get(k,d), also set D[k]=d if k not in D", default_args = {
            "k", "d" })
    ...
    @org.python.Method(__doc__ = "D.update([E, ]**F) -> None.  Update D from dict/iterable E and F.\n"
            + "If E is present and has a .keys() method, then does:  for k in E: D[k] = E[k]\n"
            + "If E is present and lacks a .keys() method, then does:  for k, v in E: D[k] = v\n"
            + "In either case, this is followed by: for k in F:  D[k] = F[k]", default_args = {
                    "iterable" }, kwargs = "kwargs")
            ...
            while (true) {
                try {
                    ...
                    if (next instanceof org.python.types.List) {
                        ...
                        throw new org.python.exceptions.TypeError(
                                "cannot convert dictionary update sequence element #" + size + " to a sequence");
                    }

                    if (pair.size() != 2) {
                        throw new org.python.exceptions.ValueError("dictionary update sequence element #" + size
                                + " has length " + pair.size() + "; 2 is required");
                    }
    ...
    @org.python.Method(__doc__ = "D.values() -> an object providing a view on D's values")
    public org.python.Object values() {
        // throw new org.python.exceptions.NotImplementedError("dict.values() has not
        // been implemented.");
